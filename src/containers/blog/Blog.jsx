...
const Blog = () => {
    ...
    const [dataBlock] = useState({
        ...
        title: 'Meet our TEAM',
        desc: 'Who we are',
        text: 'We are pioneers in the NFT space, passionate about merging art and technology. With a vision for innovation, we curate and create unique digital assets that redefine ownership in the digital age'
    })
